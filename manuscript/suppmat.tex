...
For simulated data, size factors were defined as the mean-adjusted library sizes, i.e., after dividing all library sizes by the mean library size.
...
The conversion was performed by scaling each size factor by the mean of the original library sizes across all cells, to recover the scale of the original library sizes.
Note that, in all cases, scaling all of the size factors by a constant is permissable as it does not affect the relative normalization between cells.
