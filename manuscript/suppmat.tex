...
\caption{
    ...
    The significance of the difference in the enrichment of these factors in the top set of 250 genes between summed and single-cell analyses was quantified using a Fisher's exact test, yielding a $p$-value of 0.030.
}
\end{figure}
