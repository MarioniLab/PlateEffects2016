...
\begin{figure}[p]
    \begin{center}
        \includegraphics[width=0.8\textwidth]{extra_failsim.pdf}
    \end{center}
    \caption{    
...
\begin{figure}[p]
    \begin{center}
        \includegraphics[width=0.5\textwidth]{extra_okaysim.pdf}
    \end{center}
    \caption{   
...
\begin{figure}[p]
    ...
    \begin{minipage}{0.32\textwidth}
        \includegraphics[width=\textwidth]{extra_power_2.pdf}
        \subcaption[]{}
        \label{subfig:noplate}
    \end{minipage}
    \begin{minipage}{0.32\textwidth}
        \includegraphics[width=\textwidth]{extra_power_3.pdf}
        \subcaption[]{}
        \label{subfig:bigfc}
    \end{minipage}
    \begin{minipage}{0.32\textwidth}
        \includegraphics[width=\textwidth]{extra_power_4.pdf}
        \subcaption[]{}
        \label{subfig:morede}
    \end{minipage}
    \end{center}
...
\begin{figure}[p]
    \begin{center}
        \includegraphics[width=0.6\textwidth]{extra_FDR.pdf}
    \end{center}
    \caption{
