...
This parametrization ensures that $E(\delta_{ik}) = 1$, i.e., the plate effect for each gene averages out across many plates.
...
Thus, the mean count across all cells and plates in group $g$ will be $\mu_{ig}$, consistent with its definition.
