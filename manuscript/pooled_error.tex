...
Further define $\theta_{jkg}$ as a random variable representing the bias in cell $j$ in plate $k$ of group $k$, also sampled from a distribution of positive values with non-zero variance.
