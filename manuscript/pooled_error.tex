...
\revised{Many studies ignore plate effects and treat cells as replicates during the DE analysis, such that the variance is estimated across cells in each group \citep{kolod2015single, kowalczyk2015single, kumar2014deconstructing, trapnell2014dynamics}}.
This strategy \revised{is} not statistically rigorous as the variability across plates will not be modelled properly.
