...
In the absence of a suitable method to remove plate effects, most studies have simply ignored them and treated cells from the same group as replicates \citep{kolod2015single,trapnell2014dynamics,avraham2015pathogen}.
