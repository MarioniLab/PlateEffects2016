...
\newcommand{\suppquantile}{3}
\newcommand{\suppmeanvar}{4}
\newcommand{\supphiddenvar}{5}
\newcommand{\suppnorm}{6}

% Supplementary figures
\newcommand{\suppfailsim}{S1}
\newcommand{\suppokaysim}{S2}
\newcommand{\suppcompsim}{S3}
\newcommand{\suppexpprof}{S4}
