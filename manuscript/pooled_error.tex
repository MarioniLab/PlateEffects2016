...
This is done to fulfill the distributional assumptions of methods like edgeR and DESeq that do not allow for variable dispersions between counts for the same gene.
