...
Specifically, the plate effect is independently sampled from $Z$ for each plate, which means that it will not introduce unexpected similarities between the count sums for different plates.
