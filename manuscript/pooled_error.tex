...
Note that voom mitigates the effect of imprecise estimation with few plates, by sharing information across genes to obtain a consensus value -- however, this will introduce biases when the true correlation varies between genes.
