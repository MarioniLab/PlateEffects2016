...
The estimated variance will include the conditional variance between cells on each plate, i.e., var$(X_{ik})$, as well as the variance of $\delta_{ik}$ between plates.
