...
This is attributable to the presence of independent counts and proper consideration of the true number of residual d.f.\ in the model.
Overconfident estimation of model parameters is subsequently avoided.
