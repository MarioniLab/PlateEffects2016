...
That said, the latter analysis is only valid under the assumption that no plate effect exists -- to verify this assumption, one would have to generate data from replicate plates, such that summation would become applicable.}    

In general, experimental designs involving \revised{several plates nested in each group are most common.
These provide the necessary replication across populations while being easier to generate than plates of mixed groups.}
For \revised{such} designs, the best way to handle plate effects is to simply increase the number of plates.
This provides more residual d.f. to precisely estimate the plate-to-plate variability after summation, albeit at the cost of \revised{experimental} resources.
...
& Single-cell & 6243 & 9458 & 7123 \\
& Summed & 3014 & 1710 & 955 \\
& Both & 2488 & 1698 & 955 \\
\hline
\multirow{3}{*}{a2i vs. serum} 
& Single-cell & 5378 & 8850 & 6031 \\
& Summed & 1688 & 774 & 245 \\
& Both & 1487 & 763 & 245 \\
\hline
%\multirow{3}{*}{PS vs. NP} 
