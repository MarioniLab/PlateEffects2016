...
The difference in strategies is due to the fact that the variability between technical replicates should be minimal as it represents measurement error, whereas the variability between cells can be arbitrarily large as it depends on the biology.
