...
Similar behaviour is observed in NB models where the variance of the sum of identical and independently NB-distributed random variables approaches Poisson.
...
Thirdly, methods like edgeR share information between genes to estimate the dispersion or variance. 
This mitigates the effect of reduced residual d.f. for count sums.
Finally, the improvement in power observed at low false positive rates may be due to the greater suitability of statistical models for large summed counts.
...
\begin{figure}[!p]
\begin{center}
\includegraphics[width=0.6\textwidth]{main_failsim.pdf}
\end{center}
\caption{
...
\begin{figure}[!p]
\begin{center}
\includegraphics[width=0.4\textwidth]{main_okaysim.pdf}
\end{center}
\caption{
