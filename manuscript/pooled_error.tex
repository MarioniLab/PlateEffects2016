...
% Of course, you could directly try to characterise the subpopulations with clustering.
...
%
% It could be argued that summation wouldn't work if you tried to use more gradated cluster identities (e.g., fractional membership or trajectories).
