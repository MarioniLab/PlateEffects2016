...
This philosophy is almost the exact opposite of that in microarray analyses involving technical replicates 
    -- there, the choice is between averaging the replicate signals or incorporating the replicate-to-replicate variability in the analysis,
    and the latter is often preferred to mitigate the effect of artifactual signals \citep{smyth2005use}.
The difference in strategies is due to the fact that variability between technical replicates should be minimal whereas variability between cells depends on biology.
