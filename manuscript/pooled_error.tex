...
Plate-specific differences in this function may compromise the accuracy of the model for the count sums.
...
Variable mean-variance relationships are not considered by most analysis methods.
For example, standard edgeR and DESeq2 analyses use a single NB dispersion estimate for each gene.
This defines an identical mean-variance relationship for all counts of the gene, which may not be accurate when the relationship varies across counts.
Any inaccuracy may affect the performance of the summation strategy when the numbers or sizes of cells vary between or within plates.
...
The DE analysis can subsequently be performed using standard methods like edgeR, without any need to consider plate-specific differences in the relationships.
...
\begin{figure}[!p]
\begin{center}
\includegraphics[width=0.48\textwidth]{failsim_with_raw.eps}
\includegraphics[width=0.48\textwidth]{failsim_without_raw.eps}
\end{center}
\caption{
...
\begin{figure}[!p]
\begin{center}
\includegraphics[width=0.48\textwidth]{failsim_with_sum.eps}
\end{center}
\caption{
...
\begin{figure}[!p]
\begin{center}
\includegraphics[width=0.48\textwidth]{power_with.eps}
\end{center}
\caption{
...
\begin{figure}[!p]
\begin{center}
\includegraphics[width=0.48\textwidth]{quantile_with.eps}
