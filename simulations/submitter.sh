...
bsub -R "rusage[mem=10000]" -n 6 -e "ESpresso/log_fail1.err" -o "ESpresso/log_fail1.out" R CMD BATCH --no-save "--args scenario=1 $failargs" failsim.R ESpresso/failsim_1.Rout
bsub -R "rusage[mem=10000]" -n 6 -e "ESpresso/log_fail2.err" -o "ESpresso/log_fail2.out" R CMD BATCH --no-save "--args scenario=2 $failargs" failsim.R ESpresso/failsim_2.Rout
bsub -R "rusage[mem=10000]" -n 6 -e "ESpresso/log_fail3.err" -o "ESpresso/log_fail3.out" R CMD BATCH --no-save "--args scenario=3 $failargs" failsim.R ESpresso/failsim_3.Rout
bsub -R "rusage[mem=10000]" -n 6 -e "ESpresso/log_fail4.err" -o "ESpresso/log_fail4.out" R CMD BATCH --no-save "--args scenario=4 $failargs" failsim.R ESpresso/failsim_4.Rout
bsub -R "rusage[mem=10000]" -n 6 -e "ESpresso/log_fail5.err" -o "ESpresso/log_fail5.out" R CMD BATCH --no-save "--args scenario=5 $failargs" failsim.R ESpresso/failsim_5.Rout
bsub -R "rusage[mem=10000]" -n 6 -e "ESpresso/log_fail6.err" -o "ESpresso/log_fail6.out" R CMD BATCH --no-save "--args scenario=6 $failargs" failsim.R ESpresso/failsim_6.Rout
bsub -R "rusage[mem=10000]" -n 6 -e "ESpresso/log_fail8.err" -o "ESpresso/log_fail8.out" R CMD BATCH --no-save "--args scenario=8 $failargs" failsim.R ESpresso/failsim_8.Rout
...
do
    ...
    mkdir -p $tmpdir/$i
    newname="jobsim7_${i}"
    bsub -J $newname -R "rusage[mem=${memory}]" -n $ncores -e "${tmpdir}/log_fail7_${i}.err" -o "${tmpdir}/log_fail7_${i}.out" \
