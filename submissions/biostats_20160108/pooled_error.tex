...
\includegraphics[width=0.48\textwidth]{power_with_zoom.eps}
\end{center}
\caption{
...
%\includegraphics[width=0.48\textwidth,trim=0mm 0mm 0mm 10mm,clip]{quantile_without.eps} % Doesn't really add any value; didn't put up control before either, so why do it now?
\end{center}
\caption{
